...
def pipeline(df, return_stats=False):
    # (0) Subsetting data
    data_baseline_290 = df[df['visit'].values == ["Baseline"]] # PROBLEM - NOT WORKING. Selecting BASELINE visits only
    ...
    print("data_baseline_290(2):", data_baseline_290.shape)
    ...
    # (1c) Re-splitting updated data for step (2)
