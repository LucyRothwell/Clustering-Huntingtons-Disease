...
# (2) Delete medical history / demographic features (leaving only test-related features)
# (3) Missing values functions
# (4) Remove outliers function
# (5) Normality test
...
# -------------------- (6) REGRESSING OUT COVARIATES FUNCTIONS ---------------------------------------------------------
